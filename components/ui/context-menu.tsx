...
>(({ className, ...props }, ref) => (
	<ContextMenuPrimitive.Arrow
		ref={ref}
		className={cn("fill-popover stroke-2 stroke-border shadow-md", className)}
		{...props}
	/>
));
...
export {
  ContextMenu, ContextMenuArrow, ContextMenuCheckboxItem, ContextMenuContent, ContextMenuGroup, ContextMenuItem, ContextMenuLabel, ContextMenuPortal, ContextMenuRadioGroup, ContextMenuRadioItem, ContextMenuSeparator,
